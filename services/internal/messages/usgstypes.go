...
type Properties struct {
	...
	Time          int64    `json:"time"`    // this field will be converted to time.Time by the writer component
	Updated       int64    `json:"updated"` // this field will be converted to time.Time by the writer component
